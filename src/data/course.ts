...
const feedbackDrivenLessonDetails: Record<string, Partial<Lesson>> = {
  ...
  "vor-dme-basics": lessonPlan(
    "VOR es una estación en tierra. La aguja CDI te muestra si el curso seleccionado queda a izquierda o derecha; TO significa que ese curso te lleva hacia la estación y FROM que te aleja. DME es solo distancia a la estación. No memorices una frecuencia: elige una que el mapa de TU simulador muestre como VOR válido y compruébala antes de usarla.",
    "1. Con el C172 estable, abre el mapa/EFB y activa la capa de radioayudas si está oculta. Toca un VOR cercano; anota su identificador y frecuencia.\n2. En el G1000 busca NAV1. Ajusta esa frecuencia en la ventana de espera y usa el botón de intercambio para pasarla a activa; confirma que la frecuencia activa es la que anotaste.\n3. Espera señal o identificación válida. Si no aparece, el VOR puede estar fuera de alcance, apagado o mal sintonizado: no sigas la aguja.\n4. Pulsa CDI hasta que el PFD indique NAV1/VOR, no GPS.\n5. Ajusta el curso hasta que aparezca TO. Si la aguja queda a la izquierda, el curso está a tu izquierda: haz una corrección suave para interceptarlo.\n6. Lee DME como distancia. Antes de terminar, vuelve CDI a GPS para no dejar el avión configurado en VOR por accidente.",
    "No confundas rumbo del avión con radial: el radial sale DESDE la estación; TO/FROM te dice tu relación con el curso seleccionado. Si frecuencia, fuente CDI o señal no coinciden, alas niveladas y vuelve al paso anterior. No conectes NAV/AP en esta primera lectura.",
    "Sintonizar, verificar, interpretar",
    "Solo cuenta la práctica si puedes decir cuatro cosas sin adivinar: identificador del VOR, frecuencia activa NAV1, TO o FROM, y distancia DME. Luego vuelve CDI a GPS.",
    ["VOR localizado en mapa/EFB", "Identificador y frecuencia anotados", "Frecuencia en NAV1 activa", "Señal válida comprobada", "CDI muestra NAV1/VOR", "TO/FROM leído", "DME leído", "CDI devuelto a GPS"],
  ),
  "g1000-gps-route": lessonPlan(
    "GPS guía una ruta que ya existe; no decide altitud, combustible ni seguridad. Antes de seguirlo confirma: el plan tiene origen y destino correctos; el siguiente punto es el que esperas; y el CDI del PFD dice GPS. Una línea magenta sin esas tres comprobaciones no es una instrucción.",
    "1. En la EFB crea y revisa SKCL–SKUL antes de iniciar.\n2. Ya en crucero estable, en la pantalla MFD pulsa FPL. Lee origen, destino y el primer/siguiente punto; si alguno no coincide, no actives NAV.\n3. En el PFD localiza la etiqueta CDI. Pulsa CDI hasta que muestre GPS; detente si ves NAV1/VOR.\n4. Mira la línea magenta en el mapa solo para confirmar posición; vuelve la mirada afuera y al PFD.\n5. Para Direct-To: pulsa D→, escribe o selecciona SKUL, revisa el aeropuerto que aparece y confirma. Úsalo solo si quieres ir directamente a SKUL, no para corregir cada desviación pequeña.\n6. Al terminar, vuelve a FPL y confirma qué tramo quedó activo.",
    "No cambies FPL, CDI o Direct-To durante despegue, ascenso, aproximación o mientras el avión se aleja de control. Si FPL dice una cosa y el mapa otra, mantén control manual y corrige el plan antes de usar piloto automático.",
    "Plan GPS verificable",
    "En aire estable, muestra FPL y di: origen, destino, siguiente punto y fuente CDI. La lección termina solo cuando el CDI diga GPS y puedas explicar qué hará Direct-To antes de pulsarlo.",
    ["Ruta revisada primero en EFB", "FPL abierto en MFD", "Origen y destino confirmados", "Siguiente punto identificado", "CDI muestra GPS", "Direct-To entendido antes de usarlo", "Vista exterior recuperada"],
  ),
  "c172-autopilot-basics": lessonPlan(
    "El piloto automático ejecuta el modo que está activo, no el que tú crees haber seleccionado. HDG sigue el bug de rumbo; ALT mantiene la altitud actual; NAV sigue la fuente CDI. Antes de pulsar AP, el avión debe estar estable, lejos del aeropuerto y con altitud/ruta ya entendidas.",
    "1. En aire calmo, recto y nivelado a 7.500 ft MSL, ajusta el bug de rumbo a un valor que puedas reconocer, por ejemplo 090°.\n2. Pulsa AP y después HDG. Mira el PFD: confirma el anuncio HDG y observa que el avión gira suavemente hacia el bug. Si no gira como esperas, desconecta AP y revisa el bug.\n3. Cuando esté nivelado, pulsa ALT. Confirma en el PFD que ALT mantiene la altitud actual; no asumas que subirá o bajará a un número que no configuraste.\n4. Para NAV, abre FPL, confirma ruta válida y CDI=GPS. Solo cerca de la línea magenta pulsa NAV; puede mostrarse armado antes de capturar. Observa el PFD hasta ver la captura.\n5. Desconecta AP deliberadamente, toma el yoke y mantén alas niveladas. Siempre debes poder recuperar control manual en un toque.",
    "HDG no sigue GPS. NAV no funcionará correctamente con CDI en VOR/NAV1 o al intentar capturar la línea desde un ángulo grande. No uses AP en despegue, final ni para evitar mirar instrumentos.",
    "Un modo por vez",
    "Demuestra AP+HDG, luego ALT y finalmente NAV con CDI=GPS. Después desconecta AP y escribe qué anuncio viste en el PFD para cada modo.",
    ["Zona segura y avión estable", "Bug de rumbo preparado", "HDG confirmado en PFD", "ALT confirmado en PFD", "FPL y CDI=GPS comprobados antes de NAV", "Captura NAV supervisada", "AP desconectado y control manual recuperado"],
  ),
  "navigation-consolidation": lessonPlan(
    "Este vuelo une la cadena sin saltos: plan en EFB, tiempo/combustible, control manual, FPL/CDI, automatización supervisada y llegada manual. La regla es aviar primero: si un dato no coincide, alas niveladas, altitud segura y potencia estable; solo después miras mapa, FPL o combustible.",
    "1. En EFB crea SKCL–SKUL, verifica línea, distancia, rumbo general y dos referencias visuales.\n2. Calcula tiempo con 100 kt de planificación, añade taxi/reserva y carga combustible de práctica. Anota crucero 7.500 ft MSL.\n3. Despega y asciende manualmente; no abras FPL ni AP durante la salida.\n4. En crucero estable abre FPL, confirma siguiente punto y CDI=GPS.\n5. Si corresponde, usa AP+HDG y ALT. Solo arma NAV cuando ya estés cerca de la línea magenta y verifica captura en el PFD.\n6. Cada 15 minutos compara posición, tiempo transcurrido y combustible indicado con tu plan.\n7. Antes de llegar, desconecta AP, recupera control manual y usa el procedimiento de circuito de Nivel 2.",
    "No dejes AP conectado hasta final. No cambies planificación mientras ruedas o aterrizas. Si GPS, mapa, combustible y lo que ves afuera no coinciden, no sigas presionando botones: estabiliza el avión y revisa uno por uno.",
    "Vuelo VFR planificado y supervisado",
    "Completa SKCL–SKUL o pausa en crucero seguro. Entrega un debrief: rumbo previsto frente al real, combustible previsto frente al indicado, una referencia visual y el modo AP que supervisaste.",
    ["EFB, ruta y referencias preparados", "Tiempo y combustible calculados", "Cruce manual estabilizado", "FPL y CDI=GPS revisados", "AP usado solo en crucero", "Chequeo de 15 minutos hecho", "AP desconectado antes de la llegada", "Debriefing escrito"],
  ),
  "first-vfr-navigation": lessonPlan(
    "VFR significa usar primero lo que ves afuera y usar la EFB como respaldo. La ruta SKCL–SKUL es una práctica corta: antes de despegar debes poder explicar por dónde vas, qué rumbo general esperas y dos referencias que confirmarás mirando fuera.",
    "1. En EFB deja SKCL–SKUL visible; anota rumbo general, distancia y dos referencias grandes.\n2. Tras despegar, no mires el mapa durante ascenso: primero alas niveladas, velocidad y altitud segura.\n3. En crucero a 7.500 ft MSL, mira fuera y busca la primera referencia.\n4. Revisa mapa/EFB brevemente: ¿tu posición está donde esperabas? Cierra o vuelve la vista afuera.\n5. Si necesitas corrección, cambia rumbo poco a poco hacia la referencia, espera y vuelve a comparar.\n6. A mitad de ruta compara tiempo transcurrido, combustible y posición; no uses GPS/AP para sustituir la mirada exterior en este ejercicio.",
    "No sigas el mapa con la cabeza abajo ni intentes una ruta larga. Si te desorientas: alas niveladas, altitud segura, potencia estable; después busca una referencia grande y usa mapa solo para confirmar.",
    "Dos referencias y una corrección",
    "Vuela o pausa en un punto seguro de SKCL–SKUL. Debes poder nombrar dos referencias que viste, tu rumbo general y una corrección que hiciste sin mirar la pantalla durante esa corrección.",
    ["Ruta revisada antes de despegar", "Dos referencias visuales anotadas", "Salida y ascenso controlados sin mapa", "Posición confirmada en crucero", "Una corrección pequeña aplicada", "Tiempo, combustible y posición comparados"],
  ),
  "vfr-consolidation": lessonPlan(
    "Esta práctica consolida navegación visual antes de automatizarla. La prioridad es: controlar el avión, mirar afuera, confirmar plan y comparar combustible/tiempo. La EFB y G1000 respaldan una decisión; no reemplazan vigilar terreno, clima o pista.",
    "1. Prepara SKCL–SKUL en EFB: origen, destino, línea, rumbo, distancia, 7.500 ft MSL, dos referencias y combustible previsto.\n2. Despega manualmente y alcanza crucero; no uses GPS/AP hasta estar estable.\n3. Cada 15 minutos realiza el mismo chequeo: posición en mapa, tiempo transcurrido, combustible indicado, referencia visual y rumbo.\n4. Si un valor difiere, anótalo y descubre la causa con una sola comprobación a la vez.\n5. Antes de llegar, desconecta cualquier automatización, recupera control manual y prepara circuito como en Nivel 2.",
    "No intentes corregir tiempo, combustible y rumbo al mismo tiempo. Un dato distinto no significa que debas girar inmediatamente: primero confirma que el avión está estable y que leíste el dato correcto.",
    "Vuelo VFR completo con debrief",
    "Al terminar, registra cinco datos: rumbo previsto/real, tiempo previsto/real, combustible previsto/indicado, dos referencias visuales y una decisión tomada después de comparar datos.",
    ["EFB preparada antes del arranque", "Crucero de 7.500 ft MSL confirmado", "Tres chequeos de navegación definidos", "Tiempo y combustible comparados", "Referencias visuales identificadas", "Control manual recuperado antes de llegada", "Debriefing completo"],
  ),
};
